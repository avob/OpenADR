...
public class Oadr20bVENEiEventServiceTest {
    ...
    // }
    //
    // private OadrEvent createOadrEvent(String eventId, long
    // modificationNumber) {
    // long timestampStart = 0L;
    // String eventXmlDuration = "PT1H";
    // String toleranceXmlDuration = "PT5M";
    // String notificationXmlDuration = "P1D";
    // EiActivePeriodType period =
    // Oadr20bEiEventBuilders.newOadr20bEiActivePeriodTypeBuilder(timestampStart,
    ...
    // .newOadr20bEiEventSignalTypeBuilder(signalId, signalName, signalType,
    // currentValue)
    // .addInterval(Oadr20bEiBuilders
    // .newOadr20bSignalIntervalTypeBuilder(intervalId, timestampStart,
    // xmlDuration, values).build())
    // .build();
    //
    // EiTargetType target =
    // Oadr20bEiBuilders.newOadr20bEiTargetTypeBuilder().addGroupId("groupId")
    ...
    // .newOadr20bEventDescriptorTypeBuilder(datetime, eventId,
    // modificationNumber, marketContextValue, status)
    // .withPriority(priority).withVtnComment(comment).build();
    //
    // return
    // Oadr20bEiEventBuilders.newOadr20bDistributeEventOadrEventBuilder().withActivePeriod(period)
    // .withEiTarget(target).withEventDescriptor(descriptor).addEiEventSignal(eiEventSignal).build();
    // }
    //
    // @Test
    // public void oadrDistributeEventTest() throws Oadr20bException,
    // Oadr20bHttpLayerException,
    // Oadr20bXMLSignatureException, Oadr20bXMLSignatureValidationException {
    //
    // String vtnSource = "source";
    //
    // OadrHttpVenClient20b mockOadrHttpVenClient20a =
    // Mockito.mock(OadrHttpVenClient20b.class);
    ...
    // OadrDistributeEventType build =
    // Oadr20bEiEventBuilders.newOadr20bDistributeEventBuilder("vtnId",
    // "requestId")
    ...
    //
    // assertEquals(1,
    // oadr20bVENEiEventService.getOadrEvents(vtnSource).size());
    //
    // event1 = createOadrEvent("event1", 1L);
    // build = Oadr20bEiEventBuilders.newOadr20bDistributeEventBuilder("vtnId",
    // "requestId").addOadrEvent(event1)
    // .build();
    //
    // // update event1
    // oadr20bVENEiEventService.oadrDistributeEvent(vtnSource, build);
