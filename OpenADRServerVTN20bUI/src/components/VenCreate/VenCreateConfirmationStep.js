        ...
        <SnackbarContent
              ...
              message={
                <span id="client-snackbar" className={classes.message}>
                  <WarningIcon style={{width:40, height:40, marginRight:60}}className={classNames(classes.icon, classes.iconVariant)}/>
                  {props.message}
                </span>
              }
            ...
            <WarningSnackbar
                message={
                  <Typography gutterBottom style={{color:"white"}}>
                    <strong>
                Authentication using login / password is required.<br/>
                VenID is used as VEN login
                </strong>
                  </Typography>
          ...
          <Grid item xs={ 6 }>
              <WarningSnackbar
                  message={
                    <Typography gutterBottom style={{color:"white"}}>
                      <strong>
                  Authentication using x509 client certificate is required.<br/>
                  </strong>
                    </Typography>
        ...
        <Grid item xs={ 6 }>
            <WarningSnackbar
                message={
                  <Typography gutterBottom style={{color:"white"}}>
                    <strong>
                Certificate won't be generated for this VEN.<br/>
                Provided venId MUST match with VEN certificate fingerprint 
                </strong>
                  </Typography>
        ...
        <Grid item xs={ 6 }>
            <WarningSnackbar
                message={
                  <Typography gutterBottom style={{color:"white"}}>
                    <strong>
                Certificate will be generated for this VEN and can only be downloaded at the end of this form.<br/>
                Certificate can't be regenerated without re-creating the VEN.
                </strong>
                  </Typography>
