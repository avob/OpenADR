...
public class InitKnownController {
	...
	private List<KnownUnit> getPowerUnit() throws Oadr20bMarshalException {
		...
		units.add(
				from(Oadr20bFactory.createPowerRealType(PowerRealUnitType.JOULES_PER_SECOND, SiScaleCodeType.NONE, null, null, false)));

		units.add(from(Oadr20bFactory.createPowerRealType(PowerRealUnitType.WATT, SiScaleCodeType.NONE, null, null, false)));
	...
	private void initKnownSignal() throws Oadr20bMarshalException {
		...
		signals.add(from(DemandResponseEventSignalNameEnum.ELECTRICITY_PRICE, DemandResponseEventSignalTypeEnum.PRICE_RELATIVE,
				getCurrencyUnit(CurrencyItemDescriptionType.CURRENCY_PER_K_WH)));
		
		signals.add(from(DemandResponseEventSignalNameEnum.ELECTRICITY_PRICE, DemandResponseEventSignalTypeEnum.PRICE_MULTIPLIER,
				null));
		...
		signals.add(from(DemandResponseEventSignalNameEnum.ENERGY_PRICE, DemandResponseEventSignalTypeEnum.PRICE_RELATIVE,
				getCurrencyUnit(CurrencyItemDescriptionType.CURRENCY_PER_K_WH)));
		
		signals.add(from(DemandResponseEventSignalNameEnum.ENERGY_PRICE, DemandResponseEventSignalTypeEnum.PRICE_MULTIPLIER,
				null));
		...
		signals.add(from(DemandResponseEventSignalNameEnum.DEMAND_CHARGE, DemandResponseEventSignalTypeEnum.PRICE_RELATIVE,
				getCurrencyUnit(CurrencyItemDescriptionType.CURRENCY_PER_KW)));
		
		signals.add(from(DemandResponseEventSignalNameEnum.DEMAND_CHARGE, DemandResponseEventSignalTypeEnum.PRICE_MULTIPLIER,
				null));
		...
		signals.add(from(DemandResponseEventSignalNameEnum.LOAD_CONTROL, DemandResponseEventSignalTypeEnum.X_LOAD_CONTROL_CAPACITY,
				null));
		
		signals.add(from(DemandResponseEventSignalNameEnum.LOAD_CONTROL, DemandResponseEventSignalTypeEnum.X_LOAD_CONTROL_LEVEL_OFFSET,
				null));
		
		signals.add(from(DemandResponseEventSignalNameEnum.LOAD_CONTROL, DemandResponseEventSignalTypeEnum.X_LOAD_CONTROL_PERCENT_OFFSET,
				null));
		
		signals.add(from(DemandResponseEventSignalNameEnum.LOAD_CONTROL, DemandResponseEventSignalTypeEnum.X_LOAD_CONTROL_SETPOINT,
				null));
