...
public class Oadr20bCreatedEventApplicationLayerException extends Oadr20bException
    ...
    public Oadr20bCreatedEventApplicationLayerException(Exception e, OadrResponseType response) {
        super(e);
