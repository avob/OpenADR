...
public class Oadr20bRequestEventApplicationLayerException extends Oadr20bException
    ...
    public Oadr20bRequestEventApplicationLayerException(Exception e, OadrDistributeEventType response) {
        super(e);
