...
public class Oadr20bVTNEiEventControllerTest {
     ...
     * 
     * 14: VTN, EiEvent Service, OadrDistributeEventType Payload The
     * currentValue must be set to 0 (normal) when the event is not active.
     * 
     * @throws Exception
     */
    @Test
     ...
     * 
     * 4: VTN, EiEvent Service, OadrDistributeEventType Payload - New events
     * start with a modificationNumber of 0.
     * 
     * 5: VTN, EiEvent Service, OadrDistributeEventType Payload - Each
     * modification of the oadrDisributeEvent eiEvent object, excluding
     * createdDateTime, eventStatus, and currentValue, cause the
     * modificationNumber to increment by 1 and an updated event sent to the
     * VEN. Exception: An eventStatus change to modification number to increment
     * by 1 "cancelled" shall cause the modification number to increment by 1
     * 
