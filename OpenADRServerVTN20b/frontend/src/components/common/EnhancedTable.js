  ...
  return (
    ...
    >
      ...
      <div className={classes.actions}>
        ...
        {numSelected > 0 && props.actionSelected ? props.actionSelected() : null}
        {numSelected <= 0 && props.action ? props.action() : null}
        {numSelected <= 0 && props.actionSelected ? <Tooltip title="Selectable" onClick={handleSelectableClick}>
