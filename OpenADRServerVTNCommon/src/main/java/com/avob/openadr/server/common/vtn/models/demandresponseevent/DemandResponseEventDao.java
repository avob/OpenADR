...
public interface DemandResponseEventDao extends PagingAndSortingRepository<DemandResponseEvent, Long> {
    ...
    @Query(value = "select e from DemandResponseEvent e join e.venDemandResponseEvent vd where vd.ven = :ven and :now >= e.startNotification and (e.end is null or :now < e.end)")
    ...
    @Query(value = "select e from DemandResponseEvent e join e.venDemandResponseEvent vd where vd.ven.username = :venUsername and :now >= e.startNotification and (e.end is null or :now < e.end)")
