...
public class VenDaoTest {
    ...
    public void crudTest() {
        ...
        String digestPassword = "digestmyuberplaintextpassword";
        String basicPassword = "basicmyuberplaintextpassword";

        Ven ven = new Ven();
        ven.setUsername(username);
        ven.setBasicPassword(basicPassword);
        ven.setDigestPassword(digestPassword);
