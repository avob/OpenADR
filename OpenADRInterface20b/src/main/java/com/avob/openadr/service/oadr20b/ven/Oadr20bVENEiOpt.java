 ...
 *
 */
public interface Oadr20bVENEiOpt {
     ...
     * @return
     */
    public OadrCreateOptType oadrCreatedOpt(OadrCreatedOptType payload) throws Oadr20bException;
     ...
     * @return
     */
    public OadrCancelOptType oadrCanceledOptType(OadrCanceledOptType payload) throws Oadr20bException;
