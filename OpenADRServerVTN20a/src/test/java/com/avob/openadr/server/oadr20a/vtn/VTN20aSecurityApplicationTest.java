...
@EntityScan(basePackages = { "com.avob.openadr.server.common.vtn", "com.avob.openadr.server.oadr20a.vtn" })
@ActiveProfiles({ "test" })
public class VTN20aSecurityApplicationTest extends VTN20aApplication {
