...
public class Oadr20bCreatedPartyRegistrationBuilder {
    ...
    public Oadr20bCreatedPartyRegistrationBuilder(String requestId, int responseCode, String venId, String vtnId) {
        oadrCreatedPartyRegistrationType = Oadr20bFactory.createOadrCreatedPartyRegistrationType(requestId,
                responseCode, venId, vtnId);
    }
